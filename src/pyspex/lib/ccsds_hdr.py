...
class CCSDShdr:
    ...
    def _tm_828_(self: CCSDShdr) -> np.dtype:          # ApID = 0x33C
        ...
        return np.dtype([('hdr', self.__hdr.dtype),
                         ...
                         ('SubS', '>u2'), ('SubA', '>u2'),
                         ('mono', 'u1'),  ('ImFlp', 'u1'),
                         ('ExpCtrl', '>u4'), ('ExpTime', '>u4'),
                         ('ExpStep', '>u4'), ('ExpKp1', '>u4'),
                         ('ExpKp2', '>u4'), ('NrSlope', 'u1'),
                         ('ExpSeq', 'u1'), ('ExpTime2', '>u4'),
                         ('ExpStep2', '>u4'), ('NumFr', '>u2'),
                         ('FotLen', '>u2'), ('ILvdsRcvr', 'u1'),
                         ('Calib', 'u1'), ('TrainPtrn', '>u2'),
                         ('ChEna', '>u4'), ('Icol', 'u1'),
                         ('ICOLPR', 'u1'), ('Iadc', 'u1'),
                         ('Iamp', 'u1'),('VTFL1', 'u1'),
                         ('VTFL2', 'u1'), ('VTFL3', 'u1'),
